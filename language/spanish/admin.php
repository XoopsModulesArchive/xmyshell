...
define('_AM_XMYSHELL_FILEEDITINFO2', '::<strong>NEW FILE</strong>');
...
define('_AM_XMYSHELL_CURRUSER', '<strong>Current User</strong>::<a href="#">%1$s</a>&nbsp;<input type="hidden" name=whoami value="%1$s">');
define('_AM_XMYSHELL_FILEEDITOR', '<strong>xMyShell File Editor</strong>::<strong>File</strong>::%s/%s%s');
define('_AM_XMYSHELL_FILEEDITOR2', '<strong>Current Working Directory</strong>::');
...
define('_AM_XMYSHELL_EDITMODE', '<input type="hidden" name="work_dir" value="%s"><br><strong>Save file as:</strong><input type="text" name="file" value="%s"><br>');
